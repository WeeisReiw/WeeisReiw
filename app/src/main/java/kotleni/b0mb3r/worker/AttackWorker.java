...
import kotleni.b0mb3r.services.Callback;
import kotleni.b0mb3r.services.Phone;
import kotleni.b0mb3r.services.Service;
import kotleni.b0mb3r.services.ServicesRepository;
import kotleni.b0mb3r.ui.BomberActivity;
...
//                new MainRepository(getApplicationContext().getSharedPreferences("", Context.MODE_PRIVATE)).getProxy() : new ArrayList<>();
            ...
            for (Service service : usableServices) {
                ...
                service.run(client, new Callback() {
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) {
                        if (!stopped) {
                            Intent intent = new Intent(getApplicationContext(), BomberActivity.class);
                            intent.putExtra(BomberActivity.TASK_ID, getId().toString());

                            TaskStackBuilder stackBuilder = TaskStackBuilder.create(getApplicationContext());
                            stackBuilder.addParentStack(BomberActivity.class);
